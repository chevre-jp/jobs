...
connectMongo_1.connectMongo().then(() => {
    ...
    setInterval(() => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield chevre.service.transaction.cancelReservation.exportTasks(chevre.factory.transactionStatusType.Confirmed)({ task: taskRepo, transaction: transactionRepo });
        }
        catch (error) {
            console.error(error);
        }
